            ...
            <div className="ml-4 mt-2 flex-shrink-0">
              { activeChat && activeChat.object_type == 'incidents' &&
                <button
                  ...
                  className="relative inline-flex items-center rounded-md border border-transparent bg-yellow-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2"
                >
                  View Incident
                </button>
              }
